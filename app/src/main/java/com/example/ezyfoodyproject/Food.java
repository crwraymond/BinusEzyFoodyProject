...
public class  Food extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton ng = (ImageButton) findViewById(R.id.nasigoreng);
        ImageButton b = (ImageButton) findViewById(R.id.batagor);
        ImageButton ma = (ImageButton) findViewById(R.id.mieayam);
        ImageButton ag = (ImageButton) findViewById(R.id.ayamgoreng);
        ng.setBackgroundResource(R.drawable.nasigoreng);
        b.setBackgroundResource(R.drawable.batagor);
        ma.setBackgroundResource(R.drawable.mieayam);
        ag.setBackgroundResource(R.drawable.ayamgoreng);
    }
    ...
    public void onClickNasiGoreng(View view) {
        Intent intent = new Intent(this, OrderListFood.class);
        intent.putExtra("drinks", "Nasi Goreng");
        intent.putExtra("airMineral", AMQuantity);
        intent.putExtra("jusApel", JAPQuantity);
        intent.putExtra("jusMangga", JMQuantity);
        intent.putExtra("jusAlpukat", JALQuantity);
    ...
    public void onClickBatagor(View view) {
        Intent intent = new Intent(this, OrderListFood.class);
        intent.putExtra("drinks", "Batagor");
        intent.putExtra("airMineral", AMQuantity);
        intent.putExtra("jusApel", JAPQuantity);
        intent.putExtra("jusMangga", JMQuantity);
        intent.putExtra("jusAlpukat", JALQuantity);
    ...
    public void onClickMieAyam(View view) {
        Intent intent = new Intent(this, OrderListFood.class);
        intent.putExtra("drinks", "Mie Ayam");
        intent.putExtra("airMineral", AMQuantity);
        intent.putExtra("jusApel", JAPQuantity);
        intent.putExtra("jusMangga", JMQuantity);
        intent.putExtra("jusAlpukat", JALQuantity);
    ...
    public void onClickAyamGoreng(View view) {
        Intent intent = new Intent(this, OrderListFood.class);
        intent.putExtra("drinks", "Ayam Goreng");
        intent.putExtra("airMineral", AMQuantity);
        intent.putExtra("jusApel", JAPQuantity);
        intent.putExtra("jusMangga", JMQuantity);
        intent.putExtra("jusAlpukat", JALQuantity);
